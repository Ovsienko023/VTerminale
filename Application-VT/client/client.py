...
def registration():
    data = {"password": '123'}
    url = r'http://127.0.0.2:5000/api/v2/bos/registration/'
    status = requests.post(url, json=data)
    return status.json()

def authentication():
    data = {"password": '123'}
    url = r'http://127.0.0.2:5000/api/v2/kik/authentication/'
    status = requests.post(url, json=data)
    return status.json()
...
def save_message():
    data = {"password": '123',
                ...
                "whom": 'kik',
                "data": time.time()}
    url = r'http://127.0.0.2:5000/api/v2/kik/write_message/'
    status = requests.post(url, json=data)
...
def is_whom_login():
    data = {"password": '123',
                "whom": 'kik'}
    url = r'http://127.0.0.2:5000/api/v2/kik/is_whom_login/'
    status = requests.post(url, json=data)
    return status.content

def check_message():
    data = {"password": "123"}
    url = r'http://127.0.0.2:5000/api/v2/kik/check_message/'
    status = requests.post(url, json=data)
    return status.content
